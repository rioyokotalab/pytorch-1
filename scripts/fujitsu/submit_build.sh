...
#export CC="${TCSDS_PATH}/bin/fcc -Nclang -Kfast -Knolargepage"
#export CXX="${TCSDS_PATH}/bin/FCC -Nclang -Kfast -Knolargepage"
...
ln -s ${PREFIX}/.local/lib/libtcmalloc.so ${PREFIX}/.local/lib/libtcmalloc_minimal.so

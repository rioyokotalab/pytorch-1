...
def train_opts(parser):
    ...
    group.add('--cpu_rank', '-cpu_rank', default=-1, type=int,
              help="Process ID. If set, CPU Multi Process is enabled")
    group.add('--world_size', '-world_size', default=1, type=int,
              help="total number of distributed processes.")
    group.add('--gpu_backend', '-gpu_backend',
              default="nccl", type=str,
              help="Type of GPU torch distributed backend")
    group.add('--cpu_backend', '-cpu_backend',
              default="mpi", type=str,
              help="Type of CPU torch distributed backend")
    ...
    group.add('--ppl_criteria', '-ppl_criteria', type=float, default=-1,
              help='Criteria of perplexity.')
    ...
    group.add('--trace', '-trace', action='store_true',
              help="Trace with autograd profiler. "
                   "This option is enabled only single process")
    group.add('--with_shape', '-with_shape', action='store_true',
...
def translate_opts(parser):
    ...
    group.add('--translate_steps', '-translate_steps', type=int, default=0,
              help="Number of translating steps")

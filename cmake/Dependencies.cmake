...
if(NOT INTERN_BUILD_MOBILE)
  ...
  set(AT_MKL_MT 0)
  set(USE_BLAS 1)
  if(NOT (ATLAS_FOUND OR OpenBLAS_FOUND OR MKL_FOUND OR VECLIB_FOUND OR USE_SSL2 OR GENERIC_BLAS_FOUND))
...
if(USE_MPI)
  ...
  if(CMAKE_CXX_COMPILER MATCHES ".*/FCC$")
    ...
    execute_process(COMMAND "${TCSMPI_EXEC_PATH}/mpiFCC"
...
if(USE_OPENMP)
  ...
  if(OPENMP_FOUND)
    ...
    # FIXME: FCC OpenMP flags are interpreted as a string and the build fails.
    if(CMAKE_CXX_COMPILER MATCHES ".*/FCC$")
...
if(CMAKE_CXX_COMPILER MATCHES ".*/FCC$")
  if(TCS_MPI_FOUND)
    message(WARNING "Gloo with TCS-MPI is not supported yet.")
...
if(NOT INTERN_BUILD_MOBILE)
  ...
  if(BLAS)
    if(BLAS STREQUAL "SSL2")
      ...
      message(STATUS "Force select the LAPACK API of the ${LAPACK_INFO} library.")
    else()
      find_package(LAPACK)
    endif()
  else()
